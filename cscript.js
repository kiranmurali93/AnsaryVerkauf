...
(function (global, factory) {
   ...
   * e.g. tokens parsed from "https://cdn.skypack.dev/a {{b}} c" can be serialized
...
Vue.component('checkout-area', {
 ...
 "<div class='modalWrapper' v-show='showModal'>" +
  ...
  "<i  @click='hideModal()'></i>" + //class='close fa fa-times'
   //BOC Aromal
  //display_cart()
...
var vue = new Vue({
  ...
  data: {
    productsData: [
      {
        sku: 1,
        product: "Kontaktgrill ",
        image: "https://gutfels.de/wp-content/uploads/2022/04/5810012_KG_8101_SWI_09.jpg",
        images: [
          { image: "https://gutfels.de/wp-content/uploads/2022/04/5810012_KG_8101_SWI_03.jpg" },
          { image: "https://gutfels.de/wp-content/uploads/2022/04/5810012_KG_8101_SWI_06.jpg" },
          { image: "https://gutfels.de/wp-content/uploads/2022/04/5810012_KG_8101_SWI_04.jpg" },
          { image: "https://gutfels.de/wp-content/uploads/2022/04/5810012_KG_8101_SWI_02.jpg" }
        ],
...

      {
        sku: 2,
        product: "Pürierstab",
        image: "https://gutfels.de/wp-content/uploads/2021/11/MS-8001-SWI_main.jpg",
        images: [
          { image: "https://gutfels.de/wp-content/uploads/2021/11/MS-8001-SWI_2.jpg" },
          { image: "https://gutfels.de/wp-content/uploads/2021/11/MS-8001-SWI_3.jpg" },
          { image: "https://gutfels.de/wp-content/uploads/2021/11/MS-8001-SWI_4.jpg" },
          { image: "https://gutfels.de/wp-content/uploads/2021/11/MS-8001-SWI_main.jpg" }
        ],
...

      {
        sku: 3,
        product: "BLEND 5010",
        image: "https://gutfels.de/wp-content/uploads/2022/07/5810047_BLEND-5010_49570_Main-1.jpg",
        images: [
          { image: "https://gutfels.de/wp-content/uploads/2022/07/5810047_BLEND-5010_49568_Main-1-600x600.jpg" },
          { image: "https://gutfels.de/wp-content/uploads/2022/07/5810047_BLEND-5010_49564_Detail-1-600x600.jpg" },
          { image: "https://gutfels.de/wp-content/uploads/2022/07/5810047_BLEND-5010_49557_Detail-600x600.jpg" },
          { image: "https://gutfels.de/wp-content/uploads/2022/07/5810047_BLEND-5010_49566_Detail-1-600x600.jpg" }
        ],
...
Prise: ${ total_price }<br><br>
<input id="name1" class="form-control" type="text" ng-model="${cart_items[k].title}" > 


<h6 class="cart-price">${cart_items[k].quantity}</h6>
<h6 class="cart-price">${cart_items[k].cart_price}</h6>
<input type="checkbox" value="data" name="dataprotection" required> <a href="#" data-toggle="modal" data-target="#myModal">Data Protection</a><br><br>
<input type="submit" value="Send">
<input type="reset" value="Reset">
</form>`
